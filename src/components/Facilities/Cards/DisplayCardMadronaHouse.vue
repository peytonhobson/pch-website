<template>
  <display-card header="Madrona House">
    <section class="w-full row-start-2 row-span-2">
      <img src="@/assets/madrona-house.jpg" class="w-full h-full" />
    </section>
    <section class="row-start-4 row-span-3 grid grid-rows-4">
      <section class="p-7 row-start-1 row-span-3 m-auto">
        <div class="text-lg text-left">
          Our comfortable immaculate home is located in the delightful Laurel
          Springs neighborhood in South Salem.
        </div>
      </section>
