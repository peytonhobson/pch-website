<template>
  ...
  >
    <div class="flex flex-wrap col-span-1 col-start-1 justify-center">
      ...
      >
        <img
          v-show="images[0].loaded"
          v-loadedifcomplete="images[0]"
          :src="images[0].src"
          class="w-full h-full rounded-2xl"
          @load="images[0].loaded = true"
        />
        <div v-show="!images[0].loaded" role="status">
          <svg
            aria-hidden="true"
            class="mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-black"
            viewBox="0 0 100 101"
            fill="none"
...
export default defineComponent({
  ...
  setup() {
    ...
    const images = reactive([
      ...
      {
        src: "https://pch-development-data.s3.amazonaws.com/pch_photos/other/resident-out-for-a-treat.png",
        loaded: false,
      },
      {
        src: "https://pch-development-data.s3.amazonaws.com/pch_photos/other/resident-christmas-guitar-music.png",
        loaded: false,
      },
    ]);
